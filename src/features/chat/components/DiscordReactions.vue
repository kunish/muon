...
<template>
  <div v-if="reactions.length > 0 || showPicker" class="flex flex-wrap items-center gap-1 mt-0.5">
    ...
    <button
      ...
      :key="r.key"
      class="discord-reaction inline-flex items-center gap-1 h-[22px] px-1.5 rounded-md text-[11px] border cursor-pointer transition-all duration-150"
      :class="
        r.myReaction
