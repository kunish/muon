...
<template>
  <div
    class="discord-message relative flex py-0.5 group"
    :class="[
      avatarColumnHidden
  ...
  >
    ...
    <div
      ...
      class="w-10 shrink-0 flex items-start justify-center select-none"
      :class="[
    ...
    >
      ...
      <template v-else>
        ...
        <div
          ...
          class="discord-rich-content text-[15px] leading-relaxed text-foreground/90"
...
<style scoped>
.discord-rich-content :deep(p) {
  margin: 0;
}
.discord-rich-content :deep(p + p) {
  margin-top: 0.25em;
}
.discord-rich-content :deep(a) {
  color: var(--color-primary);
  text-decoration: none;
}
.discord-rich-content :deep(a:hover) {
  text-decoration: underline;
}
.discord-rich-content :deep(a[href^='https://matrix.to']) {
  color: var(--color-primary);
  font-weight: 500;
  cursor: pointer;
...
.discord-rich-content :deep(a[href^='https://matrix.to']):hover {
  background: color-mix(in srgb, var(--color-primary) 25%, transparent);
  text-decoration: underline;
}
.discord-rich-content :deep(strong) {
  font-weight: 700;
  color: var(--color-foreground);
}
.discord-rich-content :deep(em) {
  font-style: italic;
}
.discord-rich-content :deep(code) {
  font-size: 0.85em;
...
.discord-rich-content :deep(pre code) {
  padding: 0;
  background: none;
  border: none;
}
.discord-rich-content :deep(blockquote) {
  margin: 0.3em 0;
  padding-left: 0.75em;
  border-left: 3px solid var(--color-muted-foreground);
  color: var(--color-muted-foreground);
}
.discord-rich-content :deep(ul),
.discord-rich-content :deep(ol) {
  margin: 0.2em 0;
  padding-left: 1.5em;
}
.discord-rich-content :deep(li + li) {
  margin-top: 0.1em;
}
.discord-rich-content :deep(del),
.discord-rich-content :deep(s) {
