...
// The list query auto-fetches on mount (keyed + deduped across project views).
...
<template>
  <div class="flex h-full min-h-0 min-w-0 flex-1 flex-col">
    ...
    <div v-if="loading" class="flex min-h-0 flex-1 items-center justify-center text-muted-foreground">
      {{ t('common.loading') }}
    </div>
