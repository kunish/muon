...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <!-- 顶部装饰渐变条 -->
        <div class="h-[52px] relative overflow-hidden" :style="{ background: gradient }">
          <div class="absolute inset-0 bg-gradient-to-b from-white/10 to-black/10" />
          <div
            class="absolute inset-0 opacity-20"
            style="
              background-image: url('data:image/svg+xml,%3Csvg width=&quot;40&quot; height=&quot;40&quot; viewBox=&quot;0 0 40 40&quot; xmlns=&quot;http://www.w3.org/2000/svg&quot;%3E%3Cpath d=&quot;M0 0h20v20H0zM20 20h20v20H20z&quot; fill=&quot;%23fff&quot; fill-opacity=&quot;.08&quot;/%3E%3C/svg%3E');
            "
          />
          <button
        ...
        <!-- 头像 - 浮出渐变条 -->
        <div
          class="-mt-8 flex flex-col items-center px-5 pb-1 animate-[panel-slide-in_0.32s_cubic-bezier(0.22,1,0.36,1)_both] [animation-delay:60ms]"
        >
          <div class="relative">
            <img
              v-if="resolvedAvatar"
            ...
            <!-- 在线状态点 -->
            <div
              class="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-success ring-[2.5px] ring-popover shadow-sm"
            />
          </div>
          ...
          <p v-if="userStatusMsg" class="text-[11px] text-muted-foreground/70 mt-1 truncate max-w-full">
            {{ userStatusMsg }}
          </p>
        </div>
        ...
        <!-- 信息行 - 卡片式 -->
        <div
          class="space-y-1 px-3.5 pb-2 pt-2.5 animate-[panel-slide-in_0.32s_cubic-bezier(0.22,1,0.36,1)_both] [animation-delay:120ms]"
        >
          <div
        ...
        <!-- 操作按钮 -->
        <div
          class="space-y-1.5 px-3.5 pb-3.5 pt-1 animate-[panel-slide-in_0.32s_cubic-bezier(0.22,1,0.36,1)_both] [animation-delay:180ms]"
        >
          <button
