...
const ANCHORS: Anchor[] = [
  ...
  { src: '02-docs-home.png', title: '云文档 Home', note: '文档列表表格视图（暗色）— 表格行高、列分布、协作人头像组的飞书参照' },
  { src: '03-calendar-week.png', title: '日历周视图', note: '周视图 + 日程详情 popover（暗色）— popover 阴影、字段堆叠、按钮组的飞书参照' },
  { src: '04-approval-form.png', title: '审批表单', note: '审批详情页（暗色）— 长表单字段、选项卡、行间距、内联代码块的飞书参照' },
